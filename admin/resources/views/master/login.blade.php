        ...
        <div class="col-md-10 card">
            <div class="row">
                ...
                <div style="height: 450px" class="col-md-6 bg-light">
                    <img class="w-75 m-5" src="{{ asset('layout/images/bannerImg.png') }}">
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        ...
        $('.loginForm').on('submit', function (e) {
            e.preventDefault();
            let formDataValue = $(this).serializeArray();
            let userName = formDataValue[0]['value'];
            let userPass = formDataValue[1]['value'];

            axios.post('login',{UserName: userName, UserPass: userPass})
