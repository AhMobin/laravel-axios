    ...
    <div class="row">
        <div class="col-md-6 justify-content-center">
            <div class="m-lg-5 m-md-5 p-lg-5 m-sm-3 p-sm-3 p-md-5">
                ...
                <a target="_blank" href="https://www.youtube.com/channel/UCSMFY8_rooijS-Zv43tKCrQ"><img class="" src="{{ asset('layout/images/playbtn.svg') }}"></a>
            </div>
        </div>
        <div class="col-md-6">
            <img  class="top-banner-img  animated fadeIn" src="{{ asset('layout/images/bannerImg.png')}}">
        </div>
    </div>
</div>
